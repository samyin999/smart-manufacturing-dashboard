document.addEventListener('DOMContentLoaded', function() {
    ...
    if (workerName) {
        document.getElementById('user-name-login').textContent = workerName;
    ...
    function factoryPerformancePage() {
        console.log("Navigating to the factory performance page...");
    }

    function updateMachinePage() {
        console.log("Navigating to the machine update page...");
    }
});
